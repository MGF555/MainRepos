...
namespace CodeChampsAI.Data
{
    ...
    { 
        ...
        {
            if(ConfigurationManager.AppSettings["sendconfirmationemail"] == "YES")
            {
                ...
                MailMessage sendmessage = new MailMessage
                {
                    ...
                    From = new MailAddress(ConfigurationManager.AppSettings["sendfromemail"])
                };

                sendmessage.To.Add(message.Destination);

                return client.SendMailAsync(sendmessage);
            }
